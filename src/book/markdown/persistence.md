...
#### Storage {#user.persistence.extension.storage}
...
##### Override warning {#user.persistence.extension.storage.warning}
...
##### Override implementation overview {#user.persistence.extension.storage.overview}
...
##### Asynchronous persist {#user.persistence.extension.storage.asyncper}
<!-- TODO javadoc link -->
...
##### Query / Answer {#user.persistence.extension.storage.qa}
<!-- TODO AQL explanation -->
The other type of requests that *Storage* supports 

##### General persistent object info {#user.persistence.extension.storage.objectinfo}
...
##### The ORM special {#user.persistence.extension.storage.ormspecial}
<!-- TODO list needed mav modules -->
<!-- TODO list mapping to EverBEEN classes -->

#### MapStore {#user.persistence.extension.mapstore}
